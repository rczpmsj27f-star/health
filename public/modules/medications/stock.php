...
<head>
    ...
    <style>
        ...
        /* Modal styles - ID-specific to avoid conflicts */
        #addStockModal {
            display: none;
            position: fixed;
            top: 0;
...
<body>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var removeStockModal = document.getElementById('removeStockModal');
        if (removeStockModal) {
            removeStockModal.classList.remove('active');
        }
