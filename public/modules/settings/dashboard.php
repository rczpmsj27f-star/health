    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-grid">
            ...
            <a class="tile" href="/modules/settings/notifications.php">
                ...
                <div class="tile-desc">Configure alerts and reminders</div>
            </a>
            
            <a class="tile" href="/modules/settings/preferences.php">
                <div class="tile-icon">🎨</div>
                <div class="tile-title">Preferences</div>
                <div class="tile-desc">Customize your experience</div>
            </a>
            
            <a class="tile" href="/modules/settings/security.php">
                <div class="tile-icon">🔒</div>
